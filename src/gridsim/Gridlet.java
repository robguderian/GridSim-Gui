...
public class Gridlet
{
    ...
    {
    	this(gridletID, gridletLength, gridletFileSize, gridletOutputSize, record, "", 1, "Job");
    }
    public Gridlet(int gridletID, double gridletLength,
                long gridletFileSize, long gridletOutputSize, boolean record, String growthRate, double growthFactor, String name)
    {
     ...
     */
    public Gridlet(int gridletID, double gridletLength,
                long gridletFileSize, long gridletOutputSize, String growthRate, double growthFactor, String name)
    {
        this(gridletID, gridletLength, gridletFileSize, gridletOutputSize, false, growthRate, growthFactor, name);
        this.record_ = true;
    }
    ...
    {
    	this(gridletID, gridletLength, gridletFileSize, gridletOutputSize, false, "", 1, "Job");
    	this.record_ = true;
    }
